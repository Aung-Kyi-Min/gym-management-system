                            ...
                            <div class="tab-pane" id="edit">
                                <form action="{{ url('/user/update/'.$user->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="email" class="form-control  @error('email') is-invalid @enderror" type="email" placeholder="aa@example.com" value="{{ $user->email }}" name="email">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="password" class="form-control  @error('password') is-invalid @enderror" type="password" placeholder="123" name="password">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea id="address" class="form-control  @error('address') is-invalid @enderror" placeholder="Pyay" name="address">{{ $user->address}}</textarea>
